 ...
 * @generated
 */
public class Type_enumFactoryImpl extends EFactoryImpl implements Type_enumFactory {
	/**
	 ...
	 * @generated
	 */
	public static Type_enumFactory init() {
		try {
			Type_enumFactory theType_enumFactory = (Type_enumFactory)EPackage.Registry.INSTANCE.getEFactory(Type_enumPackage.eNS_URI);
			if (theType_enumFactory != null) {
				return theType_enumFactory;
			}
		}
		catch (Exception exception) {
			EcorePlugin.INSTANCE.log(exception);
		}
		return new Type_enumFactoryImpl();
	}
	 ...
	 */
	@Override
	public Type_enumPackage getType_enumPackage() {
		return (Type_enumPackage)getEPackage();
	}
	 ...
	 */
	@Deprecated
	public static Type_enumPackage getPackage() {
		return Type_enumPackage.eINSTANCE;
	}

} //Type_enumFactoryImpl
