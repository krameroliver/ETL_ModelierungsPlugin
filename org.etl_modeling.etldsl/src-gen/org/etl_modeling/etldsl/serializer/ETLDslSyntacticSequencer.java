...
public class ETLDslSyntacticSequencer extends AbstractSyntacticSequencer {

	protected ETLDslGrammarAccess grammarAccess;
	
	@Inject
	protected void init(IGrammarAccess access) {
		grammarAccess = (ETLDslGrammarAccess) access;
	}
