      ...
      for(final Relationship relation : _relationships) {
        ...
        _builder.newLine();
        {
          ...
          if (_greaterThan_1) {
            ...
            _builder.append(_lowerCase_10);
            _builder.append("_");
            String _lowerCase_11 = relation.getToEntity().getName().toLowerCase();
            _builder.append(_lowerCase_11);
            _builder.append("_hist (like ");
            _builder.append(this.layer);
            _builder.append(".r_m_");
            ...
            _builder.append(_lowerCase_13);
            _builder.append("_");
            String _lowerCase_14 = relation.getToEntity().getName().toLowerCase();
            _builder.append(_lowerCase_14);
            _builder.append(" including all);");
            _builder.newLineIfNotEmpty();
            _builder.append("CREATE TRIGGER versioning_trigger_");
            ...
            String _lowerCase_15 = relation.getName().toLowerCase();
            _builder.append(_lowerCase_15);
            _builder.append("_");
            String _lowerCase_16 = entity.getName().toLowerCase();
            _builder.append(_lowerCase_16);
            _builder.append("_");
            String _lowerCase_17 = relation.getToEntity().getName().toLowerCase();
            ...
            _builder.append("_");
            String _lowerCase_19 = entity.getName().toLowerCase();
            _builder.append(_lowerCase_19);
            _builder.append("_");
            String _lowerCase_20 = relation.getToEntity().getName().toLowerCase();
            ...
            _builder.append("_");
            String _lowerCase_22 = entity.getName().toLowerCase();
            _builder.append(_lowerCase_22);
            _builder.append("_");
            String _lowerCase_23 = relation.getToEntity().getName().toLowerCase();
            ...
            _builder.append("_");
            String _lowerCase_25 = entity.getName().toLowerCase();
            _builder.append(_lowerCase_25);
            _builder.append("_");
            String _lowerCase_26 = relation.getToEntity().getName().toLowerCase();
            ...
            _builder.append("_");
            String _lowerCase_28 = entity.getName().toLowerCase();
            _builder.append(_lowerCase_28);
            _builder.append("_");
            String _lowerCase_29 = relation.getToEntity().getName().toLowerCase();
            ...
            String _lowerCase_30 = relation.getName().toLowerCase();
            _builder.append(_lowerCase_30);
            _builder.append("_");
            String _lowerCase_31 = entity.getName().toLowerCase();
            _builder.append(_lowerCase_31);
            _builder.append("_");
            String _lowerCase_32 = relation.getToEntity().getName().toLowerCase();
            ...
            _builder.append("_");
            String _lowerCase_34 = entity.getName().toLowerCase();
            _builder.append(_lowerCase_34);
            _builder.append("_");
            String _lowerCase_35 = relation.getToEntity().getName().toLowerCase();
            ...
            _builder.append("_");
            String _lowerCase_37 = entity.getName().toLowerCase();
            _builder.append(_lowerCase_37);
            _builder.append("_");
            String _lowerCase_38 = relation.getToEntity().getName().toLowerCase();
