...
public class ETLDslParser extends AbstractContentAssistParser {
	...
	public static final class NameMappings {
		...
		private static void init(ImmutableMap.Builder<AbstractElement, String> builder, ETLDslGrammarAccess grammarAccess) {
			...
			builder.put(grammarAccess.getEntityAccess().getGroup_7_3(), "rule__Entity__Group_7_3__0");
			...
			builder.put(grammarAccess.getEntityAccess().getFilenameAssignment_3_3(), "rule__Entity__FilenameAssignment_3_3");
			builder.put(grammarAccess.getEntityAccess().getDelimiterAssignment_3_5(), "rule__Entity__DelimiterAssignment_3_5");
			builder.put(grammarAccess.getEntityAccess().getLineendAssignment_3_7(), "rule__Entity__LineendAssignment_3_7");
			builder.put(grammarAccess.getEntityAccess().getEntityFieldAssignment_5_2(), "rule__Entity__EntityFieldAssignment_5_2");
			builder.put(grammarAccess.getEntityAccess().getEntityFieldAssignment_5_3(), "rule__Entity__EntityFieldAssignment_5_3");
			builder.put(grammarAccess.getEntityAccess().getIncludeAssignment_6_2(), "rule__Entity__IncludeAssignment_6_2");
			builder.put(grammarAccess.getEntityAccess().getIncludeAssignment_6_3_1(), "rule__Entity__IncludeAssignment_6_3_1");
			builder.put(grammarAccess.getEntityAccess().getRelationshipsAssignment_7_2(), "rule__Entity__RelationshipsAssignment_7_2");
			builder.put(grammarAccess.getEntityAccess().getRelationshipsAssignment_7_3_1(), "rule__Entity__RelationshipsAssignment_7_3_1");
			...
			builder.put(grammarAccess.getFieldAccess().getAllowExponentAssignment_12(), "rule__Field__AllowExponentAssignment_12");
			builder.put(grammarAccess.getFieldAccess().getHasImplicitCommaAssignment_13(), "rule__Field__HasImplicitCommaAssignment_13");
			builder.put(grammarAccess.getFieldAccess().getInterfaceOnlyAssignment_14(), "rule__Field__InterfaceOnlyAssignment_14");
			builder.put(grammarAccess.getFieldAccess().getTableOnlyAssignment_15(), "rule__Field__TableOnlyAssignment_15");
			builder.put(grammarAccess.getFieldAccess().getIsFastChangingAssignment_16(), "rule__Field__IsFastChangingAssignment_16");
