...
/**
 * This is the item provider adapter for a {@link jobnetz.ProcessingPoint} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ProcessingPointItemProvider 
	 ...
	 * @generated
	 */
	public ProcessingPointItemProvider(AdapterFactory adapterFactory) {
	...
	/**
	 * This adds a property descriptor for the Processing Point Type feature.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected void addProcessingPointTypePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_ProcessingPoint_ProcessingPointType_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_ProcessingPoint_ProcessingPointType_feature", "_UI_ProcessingPoint_type"),
				 JobnetzPackage.Literals.PROCESSING_POINT__PROCESSING_POINT_TYPE,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/ProcessingPoint"));
	}
	...
	public String getText(Object object) {
		String label = ((ProcessingPoint)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_ProcessingPoint_type") :
			getString("_UI_ProcessingPoint_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(ProcessingPoint.class)) {
