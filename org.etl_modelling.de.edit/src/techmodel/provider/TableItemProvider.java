...
/**
 * This is the item provider adapter for a {@link techmodel.Table} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class TableItemProvider 
	...
	protected void addTableTypePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Table_TableType_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Table_TableType_feature", "_UI_Table_type"),
				 TechmodelPackage.Literals.TABLE__TABLE_TYPE,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	protected void addFieldsPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Table_fields_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Table_fields_feature", "_UI_Table_type"),
				 TechmodelPackage.Literals.TABLE__FIELDS,
				 true,
				 false,
				 true,
				 null,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 TechmodelPackage.Literals.TABLE__ENTITY,
				 true,
				 false,
				 true,
				 null,
	...
	protected void addTechpackagePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Table_techpackage_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Table_techpackage_feature", "_UI_Table_type"),
				 TechmodelPackage.Literals.TABLE__TECHPACKAGE,
				 true,
				 false,
				 true,
				 null,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(TechmodelPackage.Literals.TABLE__FIELDS);
		}
