...
/**
 * This is the item provider adapter for a {@link specmodel.Relationship} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class RelationshipItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 SpecmodelPackage.Literals.RELATIONSHIP__TO_ENTITY,
				 true,
				 false,
				 true,
				 null,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(SpecmodelPackage.Literals.RELATIONSHIP__IDENTIFYING_FIELDS);
			childrenFeatures.add(SpecmodelPackage.Literals.RELATIONSHIP__DESCRIBING_FIELDS);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(SpecmodelPackage.Literals.RELATIONSHIP__IDENTIFYING_FIELDS,
				 SpecmodelFactory.eINSTANCE.createField()));

		newChildDescriptors.add
			(createChildParameter
				(SpecmodelPackage.Literals.RELATIONSHIP__DESCRIBING_FIELDS,
				 SpecmodelFactory.eINSTANCE.createField()));
	}
	...
	public String getCreateChildText(Object owner, Object feature, Object child, Collection<?> selection) {
		...
		boolean qualify =
			childFeature == SpecmodelPackage.Literals.RELATIONSHIP__IDENTIFYING_FIELDS ||
			childFeature == SpecmodelPackage.Literals.RELATIONSHIP__DESCRIBING_FIELDS;
